...
class CairnClient:
    ...
    def upsert_run_provenance(self, project_id: str, payload: dict[str, Any]) -> ApiResult:
        return self._request_json(
            "POST",
            f"/projects/{project_id}/runs/provenance",
            json=payload,
        )

    def patch_run_provenance(self, project_id: str, run_log_id: str, payload: dict[str, Any]) -> ApiResult:
        return self._request_json(
            "PATCH",
            f"/projects/{project_id}/runs/{run_log_id}/provenance",
            json=payload,
        )
    ...
    def update_run_session(
        ...
        *,
        ...
        return self._request_json(
            "POST",
            f"/projects/{project_id}/runs/{run_log_id}/provenance/session",
            json={
    ...
    def claim_question_job(
        ...
        *,
        ...
        return self._request_json(
            "POST",
            "/dispatcher/question-jobs/claim",
            json={
                "dispatcher_id": dispatcher_id,
                "worker_names": worker_names,
                "environment_ids": environment_ids,
    ...
    def start_question_job(self, job_id: str, dispatcher_id: str) -> ApiResult:
        return self._request_json("POST", f"/dispatcher/question-jobs/{job_id}/start", json={"dispatcher_id": dispatcher_id})

    def heartbeat_question_job(self, job_id: str, dispatcher_id: str) -> ApiResult:
        return self._request_json("POST", f"/dispatcher/question-jobs/{job_id}/heartbeat", json={"dispatcher_id": dispatcher_id})

    def append_question_events(self, job_id: str, dispatcher_id: str, batch_id: str, events: list[dict[str, Any]]) -> ApiResult:
        return self._request_json(
            "POST",
            f"/dispatcher/question-jobs/{job_id}/events",
            json={"dispatcher_id": dispatcher_id, "batch_id": batch_id, "events": events},
        )
    ...
    def finish_question_job(
        ...
        *,
        ...
        question_remote_session: dict[str, Any] | None = None,
    ) -> ApiResult:
        return self._request_json(
            "POST",
            f"/dispatcher/question-jobs/{job_id}/finish",
            json={
                "dispatcher_id": dispatcher_id,
                "result_text": result_text,
                "run_log_id": run_log_id,
                "question_remote_session": question_remote_session,
            },
        )

    def fail_question_job(self, job_id: str, dispatcher_id: str, error_code: str, error_detail: str) -> ApiResult:
        return self._request_json(
            "POST",
            f"/dispatcher/question-jobs/{job_id}/fail",
            json={"dispatcher_id": dispatcher_id, "error_code": error_code, "error_detail": error_detail},
        )

    def requeue_question_job(self, job_id: str, dispatcher_id: str, error_detail: str | None = None) -> ApiResult:
        return self._request_json(
            "POST",
            f"/dispatcher/question-jobs/{job_id}/requeue",
            json={"dispatcher_id": dispatcher_id, "error_detail": error_detail},
        )

    def cancel_question_job(self, job_id: str, dispatcher_id: str, error_detail: str | None = None) -> ApiResult:
        return self._request_json(
            "POST",
            f"/dispatcher/question-jobs/{job_id}/cancelled",
            json={"dispatcher_id": dispatcher_id, "error_detail": error_detail},
        )
